            ...
            <div className="w-full">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-6 w-full">
                    ...
                    <nav className="flex space-x-8 font-medium text-sm md:text-base">
                        ...
                        <Link to="/privacy" className="hover:text-[#42705D] transition duration-300 cursor-pointer transition-all ease-out active:scale-88 group">{t('footer.privacy')}</Link>
                    </nav>
                </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center text-xs md:text-sm font-medium text-gray-600 space-y-4 md:space-y-0 w-full">
                    ...
                    <div className="text-center md:text-left text-sm sm:text-base font-medium">
                        &copy; {currentYear} LITE cook. {t('footer.rights')}
                    </div>
                    ...
                    <div className="flex justify-center md:justify-end space-x-5">
                        ...
                        <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-[#1A1A1A] hover:text-[#42705D] transition duration-300 ease-in-out cursor-pointer transition-all ease-out active:scale-88 group">
                            <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="currentColor"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/></svg>
                        </a>
                        <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="text-[#1A1A1A] hover:text-[#42705D] transition duration-300 ease-in-out cursor-pointer transition-all ease-out active:scale-88 group">
                            <svg className="w-6 h-6 md:w-7 md:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                        </a>
                    </div>
                </div>
            </div>
