            ...
            <div className="flex flex-col items-center w-full max-w-[700px] z-10 pt-6 md:pt-0">
                ...
                <div className="w-full max-w-md font-['Inter'] mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button type="submit" className="w-full bg-[#1A1A1A] text-white font-['El_Messiri'] font-medium rounded-full py-3 md:py-3.5 hover:bg-gray-800 transition mt-4 text-base md:text-lg shadow-md">
                            Зареєструватися
                        </button>
                    </form>
