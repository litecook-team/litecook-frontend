                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-center order-2 lg:order-1 pl-6 lg:pl-16 pr-6 lg:pr-10 py-10 lg:py-20">
                        ...
                        <p className="text-gray-700 text-base md:text-lg mb-6 leading-relaxed">
                            <strong className="text-[#1A1A1A]">LITE cook</strong>{t('about_page.desc_2')}
                        </p>
                        ...
                        <p className="font-bold text-[#1A1A1A] text-base md:text-lg leading-snug">
                            {t('about_page.desc_4')}<br/>
                            <span className="font-normal text-gray-700 mt-2 block">{t('about_page.desc_5')}</span>
                        </p>
                    </div>
                    ...
                    <div className="order-4 lg:order-4 flex flex-col justify-center pl-6 lg:pl-10 pr-6 lg:pr-16 pt-16 pb-52 lg:pb-32 lg:pt-20 relative z-0 bg-[#F6F3F4]">
                        ...
                        <div className="space-y-5 max-w-[700px] mx-auto relative z-20 lg:bottom-12">
                            <div className="flex gap-6 items-center">
                                ...
                                <div>
                                    <h4 className="font-bold text-[#1A1A1A] text-xl mb-1">{t('about_page.step_1_title')}</h4>
                                    <p className="text-base md:text-lg text-gray-600 leading-relaxed">{t('about_page.step_1_desc')}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6 items-center">
                                ...
                                <div>
                                    <h4 className="font-bold text-[#1A1A1A] text-xl mb-1">{t('about_page.step_2_title')}</h4>
                                    <p className="text-base md:text-lg text-gray-600 leading-relaxed">{t('about_page.step_2_desc')}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-6 items-center">
                                ...
                                <div>
                                    <h4 className="font-bold text-[#1A1A1A] text-xl mb-1">{t('about_page.step_3_title')}</h4>
                                    <p className="text-base md:text-lg text-gray-600 leading-relaxed">{t('about_page.step_3_desc')}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#F6F3F4] backdrop-blur-md border border-gray-200 shadow-[0_10px_40px_rgba(0,0,0,0.08)] rounded-2xl p-6 lg:p-8 flex flex-col sm:flex-row items-center justify-between gap-6 w-[90%] max-w-[810px] mx-auto absolute bottom-8 lg:bottom-0 left-1/2 -translate-x-1/2 z-30">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="font-bold text-[#1A1A1A] text-base md:text-xl text-center sm:text-left">{t('about_page.banner_text')}</span>
                            </div>
                            <Link
                                to="/recipes"
