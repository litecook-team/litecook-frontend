            ...
            <div className="w-full px-4 sm:px-6 lg:px-24 pt-48 lg:pt-60 relative z-10">
                            ...
                            {isEditingName ? (
                                <div className="flex flex-wrap justify-center xl:justify-start gap-3 w-full xl:w-auto">
                                    <button
                                        ...
                                        className="px-6 py-2.5 md:px-8 md:py-3 bg-[#C4D5BD] text-gray-900 rounded-full font-['Inter'] font-bold text-[15px] md:text-[18px] hover:bg-[#B3C6AC] transition-colors shadow-sm cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                    >
                                        Зберегти
                                    </button>
                                    <button
                                        ...
                                        className="px-6 py-2.5 md:px-8 md:py-3 bg-white border border-gray-400 text-gray-800 rounded-full font-['Inter'] font-bold text-[15px] md:text-[18px] hover:bg-gray-100 transition-colors shadow-sm cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                    >
                                        Скасувати
                                    </button>
                                    {/* Кнопка зміни пароля */}
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-6 py-2.5 md:px-8 md:py-3 bg-transparent border-2 border-[#974F23] text-[#974F23] rounded-full font-['Inter'] font-bold text-[15px] md:text-[18px] hover:bg-[#974F23] hover:text-white transition-colors shadow-sm cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                    >
                                ...
                                <button
                                    ...
                                    className="w-full sm:w-auto px-6 py-2.5 md:px-12 md:py-3 bg-[#C4D5BD] text-[#974F23] rounded-full font-['Inter'] font-medium text-[15px] md:text-[18px] hover:bg-[#B3C6AC] transition-colors whitespace-nowrap shrink-0 cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                >
                                    Редагувати профіль
                                </button>
                            )}
                ...
                <div className="border-t-2 border-gray-800 pt-6 pb-4 mb-10 flex flex-wrap justify-center lg:justify-between px-4 lg:px-12 gap-4 sm:gap-6 lg:gap-8">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 sm:gap-3 hover:text-[#42705D] transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                    >
                    ...
                    <button onClick={() => handleNavClick(cuisinesRef)} className="flex items-center gap-2 sm:gap-3 hover:text-[#42705D] transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group">
                    ...
                    <button onClick={() => handleNavClick(allergiesRef)} className="flex items-center gap-2 sm:gap-3 hover:text-[#42705D] transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group">
                    ...
                    <button onClick={() => handleNavClick(dietsRef)} className="flex items-center gap-2 sm:gap-3 hover:text-[#42705D] transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 sm:gap-3 transition-colors hover:text-[#42705D] cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                    >
                        ...
                        <div className="flex flex-wrap gap-4 mt-6">
                            {safeInventory.map(item => (
                                <div key={item.id} className="flex items-center gap-3 bg-white/90 border border-gray-800 rounded-full pl-2 pr-5 py-2 shadow-sm hover:border-[#6A907B] transition-colors">
                                    ...
                                    <button onClick={() => removeFridgeItem(item.id)} className="text-gray-900 font-bold text-lg ml-1 hover:text-red-500 cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                </div>
                            ))}
                        ...
                        <div ref={dietsRef}>
                            <div className="flex items-center gap-4 mb-6">
                                <button
                                    ...
                                    className="bg-[#B9D0B2] border border-gray-800 text-gray-900 px-5 md:px-6 py-2 md:py-2.5 rounded-full text-[15px] md:text-[18px] font-semibold hover:bg-[#A8C0A0] transition-colors shadow-sm whitespace-nowrap cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                >
                                    + Додати обмеження
                                </button>
                            ...
                            {showAddDiet && (
                                <div ref={addDietWrapperRef} className="flex items-center gap-3 mb-6 bg-white/90 p-2 pl-4 rounded-full border border-gray-400 shadow-sm max-w-lg z-20 relative">
                                    ...
                                    <button onClick={() => setShowAddDiet(false)} className="text-gray-400 hover:text-gray-800 px-2 font-bold text-lg transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                    <button onClick={addDiet} className="bg-gray-900 text-white px-5 md:px-6 py-2 rounded-full text-[14px] sm:text-[15px] font-bold hover:bg-gray-700 transition-colors shadow-sm cursor-pointer transition-all duration-300 ease-out active:scale-95 group">Зберегти</button>
                                </div>
                            )}
                            ...
                            <div className="flex flex-wrap gap-4">
                                {safeDiets.map(diet => (
                                    <div key={diet} className="flex items-center gap-3 bg-white/90 border border-gray-800 rounded-full pl-2 pr-5 py-2 shadow-sm hover:border-blue-400 transition-colors">
                                        ...
                                        <button onClick={() => removeDiet(diet)} className="text-gray-900 font-bold ml-2 hover:text-red-500 cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                    </div>
                                ))}
                            </div>
                        </div>
                                ...
                                <div ref={addAllergyWrapperRef} className="relative mb-6 max-w-lg z-20">
                                    <div className="flex items-center gap-3 bg-white/90 p-2 pl-4 sm:pl-5 rounded-full border border-gray-400 shadow-sm transition-all focus-within:border-[#6A907B] focus-within:ring-2 focus-within:ring-[#6A907B]/20">
                                        ...
                                        <input
                                            ...
                                            autoFocus
                                        />
                                        <button onClick={() => { setShowAddAllergy(false); setAllergySearch(''); }} className="text-gray-400 hover:text-gray-800 px-3 font-bold text-lg transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                    </div>
                                ...
                                {safeAllergies.map(id => {
                                    ...
                                    return (
                                        <div key={id} className="flex items-center gap-3 bg-white/90 border border-gray-800 rounded-full pl-2 pr-5 py-2 shadow-sm hover:border-red-400 transition-colors">
                                            ...
                                            <button onClick={() => removeAllergy(id)} className="text-gray-900 font-bold ml-2 hover:text-red-500 cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                        </div>
                                    );
                                })}
                            </div>
                        ...
                        <div ref={cuisinesRef}>
                            ...
                            {showAddCuisine && (
                                <div ref={addCuisineWrapperRef} className="flex items-center gap-3 mb-6 bg-white/80 p-2 pl-4 rounded-full border border-gray-400 shadow-sm max-w-lg z-20 relative">
                                    ...
                                    <button onClick={() => setShowAddCuisine(false)} className="text-gray-400 hover:text-gray-800 px-2 font-bold text-lg transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                    <button onClick={addCuisine} className="bg-gray-900 text-white px-5 md:px-6 py-2 rounded-full text-[14px] sm:text-[15px] font-bold hover:bg-gray-700 transition-colors shadow-sm cursor-pointer transition-all duration-300 ease-out active:scale-95 group">Зберегти</button>
                                </div>
                            )}
                            ...
                            <div className="flex flex-wrap gap-4">
                                {safeCuisines.map(cuisine => (
                                    <div key={cuisine} className="flex items-center gap-3 bg-white/90 border border-gray-800 rounded-full pl-2 pr-5 py-2 shadow-sm hover:border-yellow-500 transition-colors">
                                        ...
                                        <button onClick={() => removeCuisine(cuisine)} className="text-gray-900 font-bold ml-2 hover:text-red-500 cursor-pointer transition-all duration-300 ease-out active:scale-95 group">✕</button>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <form onSubmit={handlePasswordChange} className="space-y-4">
                            ...
                            <div className="flex gap-3 pt-4">
                                <button
                                    ...
                                    className="w-1/2 bg-gray-100 text-gray-800 py-3 rounded-2xl font-bold hover:bg-gray-200 transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                >
                                    Скасувати
                                </button>
                                <button
                                    type="submit"
                                    className="w-1/2 bg-[#1A1A1A] text-white py-3 rounded-2xl font-bold hover:bg-[#6A907B] transition-colors cursor-pointer transition-all duration-300 ease-out active:scale-95 group"
                                >
                                    Зберегти
                                </button>
                            </div>
